...
- называть клиенту внутреннее название/код точки (например «ТКЧ», «МСК» и \
подобные короткие коды подразделений) — это служебное обозначение, клиенту \
нужны только адрес и часы работы, если он их спрашивает.
